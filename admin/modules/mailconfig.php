...
EOD;
	 ...
	 */
	echo '<br /><hr />';
	echo '<br /><center><input type="hidden" name="op" value="tnmlMailConfigSave" />';
...
function tnmlAbout() {
	...
	echo '<div align="center"><span class="title">TegoNuke&trade; Mailer ', TNML_VERSION, '</span><br /><br />'
		...
		. '<strong>PHPNukeMailer 1.0.9</strong><br />Created by Jonathan Estrella<br />'
		...
		. '<strong>Swift Mailer ', TNML_SWIFT_VERSION, '</strong><br />'
