...
<td class="{memberrow.ROW_CLASS}" align="center">&nbsp;{memberrow.FLAG}&nbsp;</td>
<!--<td class="{memberrow.ROW_CLASS}" align="center">&nbsp;{memberrow.AGE}&nbsp;</td>-->
<td class="{memberrow.ROW_CLASS}" align="center">&nbsp;{memberrow.JOINED}&nbsp;</td>
<td class="{memberrow.ROW_CLASS}" align="center">&nbsp;{memberrow.ONLINE_STATUS}&nbsp;</td>
<td class="{memberrow.ROW_CLASS}" align="center">&nbsp;{memberrow.POSTS}&nbsp;</td>
<td class="{memberrow.ROW_CLASS}" align="center">&nbsp;{memberrow.WWW_IMG}&nbsp;</td>
</tr>
<!-- END memberrow -->
<tr align="center">
<td class="cat" colspan="12">
