...
<form action="{S_MODEDIT_ACTION}" method="post"><table cellspacing="2" cellpadding="2" border="0" align="center" class="forumline">
	...
	<tr>
	  <td width="30%" class="catleft" align="center"><strong><span class="gen">{L_AMOUNT}</span></strong></td>
	  <td width="70%" class="catright" align="center"><strong><span class="gen">{L_MESSAGE}</span></strong></td>
	</tr>
	<tr>
	  <td class="row1">
