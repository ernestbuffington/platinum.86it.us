...
<table width="100%" cellspacing="0" cellpadding="2" border="0" align="center">
  <tr> 
	...
	<br />{CURRENT_TIME}<br /></span><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a>{NAV_CAT_DESC}</span></td>
...
<div align="left" valign="middle"><script language="javascript" type="text/javascript">
<!--
	CFIG.writeButton();
// -->
</script>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="row1" align="center" valign="middle" rowspan="4"><img src="themes/Impressed/forums/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
	<td width="20" align="center"><img src="themes/Impressed/forums/images/folder_new.gif" alt="{L_NEW_POSTS}"/></td>
	<td><span class="gensmall">{L_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="themes/Impressed/forums/images/folder.gif" alt="{L_NO_NEW_POSTS}" /></td>
	<td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="themes/Impressed/forums/images/folder_lock.gif" alt="{L_FORUM_LOCKED}" /></td>
