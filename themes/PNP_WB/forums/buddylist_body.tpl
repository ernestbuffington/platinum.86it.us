...
<form method="post" name="post" action="{S_BUDDYLIST_ACTION}">
  <table border="0" cellspacing="1" cellpadding="3" width="100%" class="forumline">
	...
	<tr>
	  <td width="30%" class="catLeft" nowrap="nowrap"><strong><span class="genmed">&nbsp;{L_BUDDY}&nbsp;</span></strong></td>
	  <td width="30%" class="cat" nowrap="nowrap"><strong><span class="genmed">&nbsp;{L_PM}&nbsp;</span></strong></td>
	  <td width="30%" class="cat" nowrap="nowrap"><strong><span class="genmed">&nbsp;{L_EMAIL}&nbsp;</span></strong></td>
	  <td width="10%" class="catRight" nowrap="nowrap"><strong><span class="genmed">&nbsp;{L_MARK}&nbsp;</span></strong></td>
	</tr>
  ...
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr>
	  ...
	  <td align="right" valign="top" nowrap="nowrap"><strong><span class="gensmall"><a href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></span></strong><br /><span class="gensmall">{S_TIMEZONE}</span></td>
	</tr>
  </table>
</form>
