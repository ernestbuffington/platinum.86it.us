...
<td class="row1" width="100%" a href="{topicrow.U_VIEW_TOPIC}"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.L_NEWS}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle"> title="{topicrow.TOPIC_CONTENT}" {topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
