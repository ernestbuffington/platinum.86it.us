...
<!-- BEGIN staff -->
  <tr> 
        ...
        <td valign="center" align="center" class="row1" nowrap="nowrap"><span class="gensmall">{staff.POSTS}<br />{staff.POST_PERCENT};<br />{staff.POST_DAY}<br />[{staff.LAST_POST}]</span>&nbsp;</td>
