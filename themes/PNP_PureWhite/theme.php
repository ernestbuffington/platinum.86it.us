...
function OpenTable() {
    ...
    echo "<tr>\n";
    echo "<td width=\"57\" height=\"51\"><img src=\"themes/PNP_PureWhite/images/tlc.gif\" alt=\"\" width=\"57\" height=\"51\"></td>\n";
    echo "<td style=\"background-image: url(themes/PNP_PureWhite/images/tm.gif)\"><img src=\"themes/PNP_PureWhite/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\"></td>\n";
    echo "<td width=\"57\" height=\"51\"><img src=\"themes/PNP_PureWhite/images/trc.gif\" alt=\"\" width=\"57\" height=\"51\"></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td style=\"background-image: url(themes/PNP_PureWhite/images/tleft.gif)\"><img src=\"themes/PNP_PureWhite/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\"></td>\n";
...
function CloseTable() {
	echo "</td>\n";    
    echo "<td style=\"background-image: url(themes/PNP_PureWhite/images/tright.gif)\"><img src=\"themes/PNP_PureWhite/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\"></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td width=\"57\" height=\"38\"><img src=\"themes/PNP_PureWhite/images/blc.gif\" alt=\"\" width=\"57\" height=\"38\"></td>\n";
    echo "<td style=\"background-image: url(themes/PNP_PureWhite/images/btm.gif)\"><img src=\"themes/PNP_PureWhite/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\"></td>\n";
    echo "<td width=\"57\" height=\"38\"><img src=\"themes/PNP_PureWhite/images/brc.gif\" alt=\"\" width=\"57\" height=\"38\"></td>\n";
    echo "</tr>\n";
    echo "</table>";
...
function themeheader() {
    ...
    $result = $db->sql_query("SELECT * FROM " . $prefix .
        "_themeconsole WHERE themename='PNP_PureWhite'");
    ...
    if (($themeconsole['disrightclick'] and !is_admin($admin)) || ($themeconsole['disrightclick'] and
        ...
        echo " <script language=\"javascript\" src=\"themes/PNP_PureWhite/scripts/norightclick.js\">\n";
        echo " </script> \n";
    }
    if (($themeconsole['disselectall'] and !is_admin($admin)) || ($themeconsole['disselectall'] and
        is_admin($admin) and $themeconsole['adminselect'])) {
        echo " <script language=\"javascript\" src=\"themes/PNP_PureWhite/scripts/noselect.js\">\n";
        echo " </script> \n";
    }
    if ($themeconsole['encrypt']) {
        include ('themes/PNP_PureWhite/scripts/csource.php');
    }
    $flash = "<img src=\"themes/PNP_PureWhite/images/logo.jpg\" width=481 height=161>";
    if ($themeconsole['searchbox'] == 1) {
        $searchbox = "<form action=\"modules.php?op=modload&name=Search&file=index\" method=\"post\"><input type=\"text\" name=\"query\" value=\"type search here\" onFocus=\"if(this.value=='type search here')this.value='';\" value style=\"width:150;height:19;\"></td><td align=center background=\"themes/PNP_PureWhite/images/PNP_PureWhite_s2.jpg\" width=49 height=21><input type=\"image\" value=\"search\" src=\"themes/PNP_PureWhite/images/search.gif\" class=noborder border=\"0\" alt=\"submit search\"></td></form>\n";
    } else {
        $searchbox = "&nbsp;</td><td><img src=\"themes/PNP_PureWhite/images/PNP_PureWhite_s2.jpg\" width=49 height=21></td>\n";
    }
...
//    echo "<body topmargin=\"0\" leftmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">";
    echo "<body>\n";	
	include_once("themes/PNP_PureWhite/header.php");
    echo "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"middle\">\n";
	echo "		<tr valign =\"top\">\n";
    echo "		<td style=\"width: 20px; background-image: url(themes/PNP_PureWhite/images/leftborder.gif)\" align=\"left\" valign =\"top\"><img src=\"themes/PNP_PureWhite/images/leftborder.gif\" width=\"20\" height=\"250\" border=\"0\" alt=\"\"></td>\n";
    echo "		<td valign =\"top\">\n";
    blocks("left");
    echo "    </td>\n";
    echo "		<td style=\"width: 5;\" valign =\"top\"><img src=\"themes/PNP_PureWhite/images/spacer.gif\" alt=\"\" width=\"5\" height=\"1\" border=\"0\"></td>\n";
    echo "		<td width=\"100%\">\n";
//NSN banner ads
    if ($banners == 1) {
...
function themefooter() {
    global $index, $user, $banners, $cookie, $prefix, $db, $foot1, $foot2, $foot3, $foot3, $banners1, $prefix, $total_time, $start_time;
...
if (defined('INDEX_FILE')) {
    ...
    echo "		</td>\n";	    
	echo "		<td valign =\"top\">\n";
    echo "		<td style=\"width: 20px; background-image: url(themes/PNP_PureWhite/images/rightborder.gif)\" align=\"right\" valign =\"top\"><img src=\"themes/PNP_PureWhite/images/rightborder.gif\" width=\"20\" height=\"250\" border=\"0\" alt=\"\"></td>\n";
    echo "	    </tr>\n";
	echo "</table>\n";    
    ...
    include("themes/PNP_PureWhite/footer.php");
...
$ThemeSel = get_theme();
    ...
    //End Code Change
    $tmpl_file = "themes/PNP_PureWhite/story_home.htm";
...
$ThemeSel = get_theme();
    ...
    $tmpl_file = "themes/PNP_PureWhite/story_page.htm";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
function themesidebox($title, $content, $bid=0) {
    $tmpl_file = "themes/PNP_PureWhite/blocks.htm";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
