...
_CFIG.prototype.genCmd = function(id, cmd, title, delim, TB)
{
	...
	s += '<a href="javascript:'+this.global+'.cmd(\''+cmd+'\');" class="gensmall" style="text-decoration:none;" onfocus="this.blur();"><span id="'+this.global+'_options_b'+id+'" style="display:none;"><strong>'+delim+'&nbsp;'+title+'&nbsp;'+delim+'</strong></span></a>';
	s += '&nbsp;</td>';
	s += '</tr></table></td>';
	s += ((TB & 2) ? '</tr></table>' : '');
	return s;
...
_CFIG.prototype.writePanel = function()
{
	...
	s += this.genRow(i++)+'<span class="gen"><strong>'+this.T['title'][1]+':</strong></span></td></tr>';
