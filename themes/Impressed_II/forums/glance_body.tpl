...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="2" cellspacing="1" border="0" class="forumline" height="100%">
	...
	<tr>
		...
		<td valign="middle" class="row2" nowrap="nowrap" align="center"><span class="genmed"><a href="{recent.FORUM_LINK}" class="genmed" title="{recent.TOPIC_CONTENT}">{recent.FORUM_TITLE}</a></span></td>
