...
<!-- Start add - Birthday MOD -->
        <tr>
          <td valign="top" class="row2"><strong><span class="genmed">{L_BIRTHDAY}</span></strong></td>
...
<!-- Start add - Gender MOD -->
        <tr>
          ...
          <td class="row1"><strong><span class="genmed">{GENDER}</span></strong></td>
        </tr>
<!-- End add - Gender MOD -->
        <tr>
...
<!-- BEGIN cashrow -->
        <tr>
          <td valign="top" class="row2"><strong><span class="genmed">{cashrow.CASH_NAME}</span></strong></td>
          <td class="row1"><span class="genmed"><strong>{cashrow.CASH_AMOUNT}</strong></span></td>
        </tr>
<!-- END cashrow -->
<!-- BEGIN switch_cashlinkson -->
        <tr>
          <td valign="top" class="row2"><strong><span class="genmed"></span></strong>
          <td><span class="gen">
<!-- BEGIN cashlinks -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
	<td align="center" class="copyright"><br />{EDIT_USER_PROFILE}<br /></td>
  </tr>
</table>
