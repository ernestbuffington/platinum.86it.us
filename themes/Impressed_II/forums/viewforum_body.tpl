<form method="post" action="modules.php?name=Forums&file=search&mode=results">
  ...
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  ...
	  <td align="right" valign="bottom" nowrap="nowrap"><span class="gensmall"><strong>{PAGINATION}</strong></span></td>
	</tr>
	<tr>
...
<!-- BEGIN switch_attached_list -->
   ...
   <table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline">
	...
	<tr>
		<td class="row1" align="center" valign="middle" height="50"><img src="{switch_attached_list.switch_attached_present.FORUM_FOLDER_IMG}" width="50" height="50" alt="{switch_attached_list.switch_attached_present.L_FORUM_FOLDER_ALT}" title="{switch_attached_list.switch_attached_present.L_FORUM_FOLDER_ALT}" /></td>
...
<td class="row1" width="100%" a href="{topicrow.U_VIEW_TOPIC}"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.L_NEWS}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" title="{topicrow.TOPIC_CONTENT}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
