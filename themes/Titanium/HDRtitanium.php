...
echo "\n\n<!-- START Header ".$domain.". -->\n\n"; 
    ...
    echo "<tr>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"20\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"231\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"19\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"16\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"179\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"43\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"24\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"145\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"73\" height=\"0\"></td>\n";
    echo "<td><img src=\"themes/".$ThemeSel."/header/spacer.png\" width=\"20\" height=\"0\"></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
	...
	# left logo
	echo "<td valign=\"top\" align=\"center\" width=\"198\" background=\"themes/".$ThemeSel."/header/smooth_skull.png\" rowspan=\"5\">\n";
   ...
   echo "<img src=\"themes/".$ThemeSel."/header/center_top_logo2.png\" border=\"0\" align=\"top\" title=\"The Ghost\"  >";
   echo "</td>";
   echo "<td background=\"themes/".$ThemeSel."/header/nukestyle-hd_full.png\" align=\"right\" colspan=6>\n";
   
   if( $titanium_browser->getBrowser() == Browser::BROWSER_IPHONE)
   echo "<img src=\"themes/".$ThemeSel."/header/menu_replacement.png\" border=\"0\" align=\"adbsmiddle\" title='' width=\"480\" >";
   else
   ...
   {                                                        
      if (@file_exists(NUKE_THEMES_DIR.$ThemeSel.'/swf/menu.swf'))
      {
        ...
        <param name="movie" value="themes/<?=$ThemeSel?>/swf/menu.swf">
        ...
        name="themes/<?=$ThemeSel?>/swf/menu.swf" 
        width="480" height="50" 
        src="themes/<?=$ThemeSel?>/swf/menu.swf" 
        quality="best" 
        wmode="transparent" 
   ...
   if(empty($ads)) 
   {
      ...
      echo "<img src=\"themes/".$ThemeSel."/banners/hacking.png\" border=\"0\" width=\"472\" height=\"74\"></a>";
   }
   else
   echo $ads;
   ...
   echo "</td></tr>\n";
   echo "<tr>\n";
   echo "<td colspan=\"6\"><img src=\"themes/".$ThemeSel."/header/nukestyle-hd_07.png\" width=\"100%\" height=\"9\"></td>\n";
   echo "</tr>\n";
   echo "<tr>\n";
   echo "<td rowspan=\"2\"><img src=\"themes/".$ThemeSel."/header/nukestyle-hd_08_fix5.png\" width=\"16\" height=\"64\"></td>\n";

   echo "<td background=\"themes/".$ThemeSel."/header/nukestyle-hd_search_fix2.png\" width=\"179\" height=\"31\">";
   ...
   echo "</td>";
   echo "<td background=\"themes/".$ThemeSel."/header/nukestyle-hd_s2_fix2.png\" width=\"43\" height=\"31\">";
   echo "</td>";
   echo "<td><img src=\"themes/".$ThemeSel."/header/nukestyle-hd_11_fix.png\" width=\"24\" height=\"31\"></td>";
   echo "<td colspan=2 background=\"themes/".$ThemeSel."/header/nukestyle-hd_time.png\" width=\"218\" height=\"31\">\n";
   ...
   echo "</tr>\n";
   echo "<tr>\n";
   echo "<td valign=middle colspan=\"4\" background=\"themes/".$ThemeSel."/header/nukestyle-hd_user.png\" width=\"391\" height=\"33\">";
   
   echo "</td><td><img src=\"themes/".$ThemeSel."/header/nukestyle-hd_u2.png\" width=\"73\" height=\"33\"></td>\n";
   echo "</tr>\n";
   echo "</table>\n"; 
...
echo "<table style=\"background: #cecece;\" cellSpacing=\"0\" cellPadding=\"0\" width=\"100%\" border=\"0\">\n";
   ...
   echo "<tr valign=\"top\">\n";
   echo "<td width=\"20\" valign=\"top\" background=\"themes/".$ThemeSel."/sides/leftbg.png\">\n";
   echo "<img src=\"themes/".$ThemeSel."/sides/leftbg.png\" width=\"20\" height=\"15\" border=\"0\">";
   echo "</td>\n";
   echo "<td width=\"20\">\n";
...
if(blocks_visible('left')) 
{
   ...
   # this controls the gap between the left block and the left side of the center table!!!
    echo "</td>\n"
    	."<td><img src=\"themes/".$ThemeSel."/images/spacer.png\" width=\"7\" height=\"0\" border=\"0\" ></td>\n"
    	."<td width=\"100%\">\n";
