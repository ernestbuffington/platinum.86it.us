...
<!-- AddToAny END --></div>      
	...
	<tr> 
		<td class="row1" colspan="2" height="1"><img src="themes/Impressed_II/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END postrow -->
	<tr align="center"> 
