...
function themesidebox($title, $content, $bid=0) 
{
   ...
   echo"<table class=block cellSpacing=\"0\" cellPadding=\"0\" border=\"0\" width=\"278px\">"
     ...
     . "<td width=\"0\" align=\"center\" background=\"themes/$theme_name/tables/OpenTable/topmiddle.png\">"
     ...
     . "<tr>"
     . "<td width=\"0\" background=\"themes/$theme_name/tables/OpenTable/leftside.png\">"
     ...
     . "</table>"
     . "</td>"
     . "<td width=\"0\" background=\"themes/$theme_name/tables/CloseTable/rightside.png\">"
     ...
     . "<td width=\"0\" height=\"27\" background=\"themes/$theme_name/tables/CloseTable/bottommiddle.png\">        </td>"
