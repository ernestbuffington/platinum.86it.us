...
<?
global $ThemeSel;  
echo "<img src=\"themes/".$ThemeSel."/header/spacer.png\" height=7><br>\n";
}
...
echo "<table class=\"maintable\" border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">";
echo "<tr>";
echo "<td background=\"themes/$theme_name/tables/OpenTable/topmiddle.png\" align=\"left\" width=\"39\" colspan=\"2\">";
echo "<img src=\"themes/$theme_name/tables/OpenTable/leftcorner.png\" width=\"39\" height=\"50\"></td>";
echo "<td valign=\"middle\" background=\"themes/$theme_name/tables/OpenTable/topmiddle.png\" width=\"100%\">";
echo "<center><strong><font color =\"$textcolor1\">$pagetitle</font></strong></center>";
echo "</td>";
echo "<td background=\"themes/$theme_name/tables/OpenTable/topmiddle.png\" align=\"right\" width=\"39\" colspan=\"2\">";
echo "<img src=\"themes/$theme_name/tables/OpenTable/rightcorner.png\" width=\"39\" height=\"50\"></td>";
echo "</tr>";
echo "<tr>";
echo "<td width=\"15\" background=\"themes/$theme_name/tables/OpenTable/leftside.png\"></td>";
echo "<td width=\"24\"></td>";
echo "<td width=\"100%\">";
echo "</opentablemodule>";  
}
