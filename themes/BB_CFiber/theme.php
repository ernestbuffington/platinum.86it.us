...
*/	
	...
	echo "		<tr valign =\"top\">\n";
    echo "		<td style=\"width: 20px; background-image: url(themes/BB_CFiber/images/leftborder.gif)\" align=\"left\" valign =\"top\"><img src=\"themes/BB_CFiber/images/leftborder.gif\" width=\"20\" height=\"250\" border=\"0\" alt=\"\"></td>\n";
    echo "		<td valign =\"top\">\n";
  global $name;
    {
    blocks("left");
...
function themefooter() {
    global $index, $user, $banners, $cookie, $prefix, $db, $foot1, $foot2, $foot3, $foot3, $babanners1, $prefix, $total_time, $start_time;
...
while(list($lid, $title, $hits) = $db->sql_fetchrow($result)) {
    ...
    $show .= "&nbsp;&nbsp;&nbsp;$a: <a href=\"modules.php?name=Web_Links&amp;l_op=viewlinkdetails&amp;lid=$lid&amp;ttitle=$title\">$title2</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font class=\"content\">$hits<font class=\"copyright\"> times<br />";
     $showlinks = " <a name= \"scrollingCode\"></a><marquee behavior= \"scroll\" align= \"left\" direction= \"up\" width=\"148\" height=\"110\" scrollamount= \"2\" scrolldelay= \"30\" onmouseover='this.stop()' onmouseout='this.start()'>$show";
...
while ($row = $db->sql_fetchrow($result)) {
    ...
    $content .= "<strong><big>&middot;</big></strong>&nbsp;$a: <a href=\"modules.php?name=Downloads&amp;d_op=viewdownloaddetails&amp;lid=$row[lid]&amp;title=$row[title]\">$title2</a><br />";
	 $showdl = " <font class=copyright>&nbsp;</strong><br />&nbsp;<a name= \"scrollingCode\"></a><marquee behavior= \"scroll\" align= \"left\" direction= \"up\" width=\"148\" height=\"110\" scrollamount= \"2\" scrolldelay= \"30\" onmouseover='this.stop()' onmouseout='this.start()'>$content";
...
if (defined('INDEX_FILE')) {
    ...
    echo "		</td>\n";	    
	echo "		<td valign =\"top\">\n";
    echo "		<td style=\"width: 20px; background-image: url(themes/BB_CFiber/images/rightborder.gif)\" align=\"right\" valign =\"top\"><img src=\"themes/BB_CFiber/images/rightborder.gif\" width=\"20\" height=\"250\" border=\"0\" alt=\"\"></td>\n";
    echo "	    </tr>\n";
	echo "</table>\n";    
