...
if (($radminsuper == 1) OR ($radminuser == 1)) {
	...
	echo '<tr><td align="right">' . _ACTALLOWREG . '</td><td>' . askYN('allowuserreg') . '</td></tr>';
	// Use Email Activation
	echo '<tr><td align="right">' . _USEACTIVATE . '<br />' . _YA_SERVERMAILNOTE . '</td><td>' . askYN('useactivate') . '</td></tr>';
	// require admins approval
	echo '<tr><td align="right">' . _REQUIREADMIN . '</td><td>' . askYN('requireadmin') . '</td></tr>';
	// force user to enter email address twice on registration
	echo '<tr><td align="right">' . _DOUBLECHECKEMAIL . '</td><td>' . askYN('doublecheckemail') . ' &nbsp;(' . _DOUBLECHECKEMAILNOTE . ')</td></tr>';
	// use COPPA
	echo '<tr><td align="right">' . _ACTIVATECOPPA . '</td><td>' . askYN('coppa') . ' &nbsp;(' . _ACTIVATECOPPANOTE . ')</td></tr>';
	// turn on TOS for new users
	echo '<tr><td align="right">' . _ACTIVATETOS . '</td><td>' . askYN('tos') . '  &nbsp;(' . _ACTIVATETOSNOTE . ')</td></tr>';
	// turn on TOS for new users
#    if (is_active('Legal')) {
  ...
  $objDocTypes = new Legal_DocTypes('', $lang);
	echo '<tr><td align="right">' . _YA_LEGAL_TOS . '</td><td>';
	...
	echo '<tr><td align="right">' . _ACTIVATETOSALL . '</td><td>' . askYN('tosall') . ' &nbsp;(' . _ACTIVATETOSALLNOTE . ')</td></tr>';
	// display "As Registered User..."
	echo '<tr><td align="right">' . _ACTALLOWASREGUSER . '</td><td>' . askYN('useasreguser') . '</td></tr>';
	echo '</table>';
	echo '</div>';
	echo '<div id="usertab2" class="tabcontent">';
	echo '<table border="0" cellpadding="1" cellspacing="1"><tr><td>';
	echo '<table border="0" cellpadding="2" cellspacing="2">';
	echo '<tr><td align="right">' . _ACTREQREALNAME . '</td><td>';
	askregfield('userealname');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWFAKE . '</td><td>';
	askregfield2('usefakeemail');
	echo '</td></tr>';
	/*
	echo '<tr><td align="right">'._YA_USEGENDER.':</td><td>';
	askregfield2('usegender');
	echo '</td></tr>';
	echo '<tr><td align="right">'._YA_USEBIRTHDAY.':</td><td>';
	askregfield2('usebirthdate');
	echo '</td></tr>';
	*/
	echo '<tr><td align="right">' . _ACTALLOWURL . '</td><td>';
	askregfield2('usewebsite');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMAIM . '</td><td>';
	askregfield2('useinstantmessaim');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMICQ . '</td><td>';
	askregfield2('useinstantmessicq');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMMSN . '</td><td>';
	askregfield2('useinstantmessmsn');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMYIM . '</td><td>';
	askregfield2('useinstantmessyim');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWLOC . '</td><td>';
	askregfield2('uselocation');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWOCC . '</td><td>';
	askregfield2('useoccupation');
	echo '</td></tr>';
	echo '</table></td><td>';
	echo '<table border="0" cellpadding="2" cellspacing="2">';
	echo '<tr><td align="right">' . _ACTALLOWINTRSTS . '</td><td>';
	askregfield2('useinterests');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWNEWSLETTER . '</td><td>';
	askregfield2('usenewsletter');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWVIEWEMAIL . '</td><td>';
	askregfield2('useviewemail');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTHIDEONLINE . '</td><td>';
	askregfield2('usehideonline');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWFORUMNOTIFYOPTIONS . '</td><td>';
	askregfield2('useforumnotifyoptions');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWSIG . '</td><td>';
	askregfield2('usesignature');
	echo '</td></tr>';
/*	echo '<tr><td align="right">' . _ACTALLOWEXTRAINFO . '</td><td>';
	askregfield2('useextrainfo');
	echo '</td></tr>';*/
	echo '<tr><td align="right">' . _ACTALLOWPOINTS . '</td><td>';
	...
	echo '<tr><td align="right">' . _SERVERMAIL . '</td><td>' . askYN('servermail') . '</td></tr>';
	// Notify admin when use registers?
	echo '<tr><td align="right">' . _ACTNOTIFYADD . '<br />' . _YA_SERVERMAILNOTE . '</td><td>' . askYN('sendaddmail') . '</td></tr>';
	// Notify admin when use deletes?
	echo '<tr><td align="right">' . _ACTNOTIFYDELETE . '<br />' . _YA_SERVERMAILNOTE . '</td><td>' . askYN('senddeletemail') . '</td></tr>';
	// Validate email change?
	echo '<tr><td align="right">' . _EMAILVALIDATE . '<br />' . _YA_SERVERMAILNOTE . '</td><td>' . askYN('emailvalidate') . '</td></tr>';
	echo '</table>';
	echo '</div>';
	////////////////////////////////////////////////////
	///   PERMISSIONS   /////
	...
	echo '<tr><td align="right">' . _ACTALLOWMAIL . '</td><td>' . askYN('allowmailchange') . '</td></tr>';
	// allow user to delete account
	echo '<tr><td align="right">' . _ACTALLOWDELETE . '</td><td>' . askYN('allowuserdelete') . '</td></tr>';
	// allow user to change themes
	echo '<tr><td align="right">' . _ACTALLOWTHEME . '</td><td>' . askYN('allowusertheme') . '</td></tr>';
	...
	echo '<tr><td align="right">' . _AUTOSUSPENDMAIN . '<br />(' . _YA_AUTOSUSPENDMAINNOTE . ')</td><td>' . askYN('autosuspendmain') . '</td></tr>';
	echo '<tr><td align="center" colspan="2">&nbsp;</td></tr>';
	echo '</table>';
	echo '</div>';
	////////////////////////////////////////////////////////////////
	...
	echo '<tr><td align="right" valign="top">' . _YA_BADNICK . ':</td><td><textarea name="xbad_nick" rows="5" cols="40">' . $ya_config['bad_nick'] . '</textarea><br />' . _YA_1PERLINE . '</td></tr>';
	echo '<tr><td align="right" valign="top">' . _YA_BADMAIL . ':</td><td><textarea name="xbad_mail" rows="5" cols="40">' . $ya_config['bad_mail'] . '</textarea><br />' . _YA_1PERLINE . '</td></tr>';
	...
	echo '<tr><td align="right" valign="top">' . _COOKIECHECKNOTE1 . '</td><td>' . askYN('cookiecheck') . ' &nbsp;(' . _COOKIECHECKNOTE2 . ')</td></tr>';
	// menelaos: enables admins to enable or disable the option for users to delete their cookies
	echo '<tr><td align="right" valign="top">' . _COOKIECLEANERNOTE1 . '</td><td>' . askYN('cookiecleaner') . ' &nbsp;(' . _COOKIECLEANERNOTE2 . ')</td></tr>';
	echo '<tr><td align="right" valign="top">' . _COOKIETIMELIFE . '</td><td><select name="xcookietimelife">';
	echo '<option value="-"';
	...
	echo '<tr><td align="right">' . _COOKIEPATH . '<br />(' . _COOKIEPATHNOTE1 . ')</td><td>';
	echo '<input type="text" name="xcookiepath" size="39" value="' . $ya_config['cookiepath'] . '" /><br />(' . _COOKIEPATHNOTE2 . ')</td></tr>';
	echo '<tr><td align="right" valign="top">' . _COOKIEINACTIVITY . '</td><td><select name="xcookieinactivity">';
	echo '<option value="-"';
