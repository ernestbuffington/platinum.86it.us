...
if (is_user($user)) {
	...
	function nav($main_up = 0) {
		...
		echo '<td width="' . $tdwidth . '%" valign="top" align="center" class="content">';
		echo '<a href="modules.php?name=Forums&file=profile&mode=editprofile"><img src="' . $menuimg . '" border="0" alt="' . _CHANGEYOURINFO . '" title="' . _CHANGEYOURINFO . '" /></a><br />';
		echo '<a href="modules.php?name=Forums&file=profile&mode=editprofile">' . _ACCTCHANGE . '</a>';
		echo '</td>';
