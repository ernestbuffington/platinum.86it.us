	...
	if ($stop == '') {
		...
		while ($sqlvalue = $db->sql_fetchrow($result)) {
			...
			if (!isset($nfield[$t]) || $nfield[$t] == '') {
				...
				echo '<p class="content" align="center"><span class="title"><strong>' . _ERRORREG . '</strong></span><br /><br />';
		...
		include_once 'header.php';
		OpenTable();
		echo '<p align="center" class="content"><span class="title"><strong>' . _ERRORREG . '</strong></span><br /><br />';
