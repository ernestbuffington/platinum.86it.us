...
OpenTable();
if ($op == 'new_user') {
	echo '<img src="modules/' . $module_name . '/images/warning.png" align="left" width="40" height="40" alt="" />' . _YATOSINTRO2;
} elseif ($setinfo['agreedtos'] == '0') {
	echo '<img src="modules/' . $module_name . '/images/warning.png" align="left" width="40" height="40" alt="" />' . _YATOSINTRO1;
}
CloseTable();
echo '<br />';
