...
if (isset($_POST['coppa_yes']) AND $ya_config['coppa'] == 1) {
	...
	if ($coppa != 1) {
		...
		title(_USERAPPLOGIN);
		OpenTable();
		echo '<img align="left" width="40" height="40" alt="" src="modules/' . $module_name . '/images/warning.png"  /> <strong>'. _YACOPPA2.'</strong>';
		CloseTable();
		echo '<br />';
		OpenTable();
		echo '<div align="cente2r"><span class="title">' . _YACOPPA1 . '</span><br />';
