...
$bbcode_tpl['code_open'] = '</span><table width="85%" cellspacing="1" cellpadding="3" border="0" align="center"><tr><td><span class="genmed"><span class="thick">Code:</span></span></td></tr><tr><td class="code">';
$bbcode_tpl['code_close'] = '</td></tr></table><span class="postbody">';
$bbcode_tpl['quote_open'] = '</span><table width="85%" cellspacing="1" cellpadding="3" border="0" align="center"><tr><td><span class="genmed"><span class="thick">Quote:</span></span></td></tr><tr><td class="quote">';
$bbcode_tpl['quote_close'] = '</td></tr></table><span class="postbody">';
$bbcode_tpl['quote_username_open'] = '</span><table width="85%" cellspacing="1" cellpadding="3" border="0" align="center"><tr><td><span class="genmed"><span class="thick">$1 Wrote:</span></span></td></tr><tr><td class="quote">';
...
return str_replace("[/color:$bbcode_uid]", $bbcode_tpl['color_close'], $hometext);
}

function dss_rand(): string {
