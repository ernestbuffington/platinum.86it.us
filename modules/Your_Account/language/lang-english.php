...
define('_ACTMSG','Your account has been created and logged in. You can click <a href=\'modules.php?name=Your_Account\'><strong>this link</strong></a> to go to your home page.');
...
define('_UPDATEBIRTH','Please update your birthdate in your profile.');
...
define('_YA_UPDATEYOUTABLE','<strong>ERROR: YOU NEED TO UPDATE YOU DATA BASE TABLE NOW!!</strong><br />Run cnbya.php from the root of your phpnuke installation, update the database tables, and delete the file afterwards!<br />The version of the module is ');
...
define('_YACOPPA2','You must be <strong>18</strong> or over to register for a membership here.');
define('_YACOPPA3','Are you age <strong>18</strong> or above? <small>Please answer yes or no and click Continue.</small>');
define('_YACOPPA4','We\'re Sorry! You must be <strong>18</strong> or over to register for a membership here.');
...
define('_YATOSINTRO2','<strong>Welcome .....<br />To apply for a membership you will have to agree with our Terms of Service.</strong>');
define('_YATT','Total');
...
define('_SPAMWARN','Are you sure you want to show your e-mail address? You will have no protection against SPAM!');
?>