...
echo '<td align="center" width="100"><strong>'._GR_NUMUSERS.'</strong></td>'."\n";
echo '<td align="center" width="100"><strong>'._GR_LIMIT.'</strong></td>'."\n";
echo '<td align="center" width="100"><strong>&nbsp;</strong></td>'."\n";
echo '</tr>'."\n";
