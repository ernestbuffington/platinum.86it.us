...
/*****************************************************/
/* Convert HTML entities back to characters    START */
/*****************************************************/
        $post_subject = htmlspecialchars_decode($privmsg['privmsgs_subject'], ENT_QUOTES);
        $private_message = htmlspecialchars_decode($privmsg['privmsgs_text'], ENT_QUOTES);
/*****************************************************/
/* Convert HTML entities back to characters      END */
/*****************************************************/
...
/*****************************************************/
/* Convert HTML characters to special entities START */
/*****************************************************/
			$privmsg_subject = $db->sql_escape_string($privmsg_subject);
			$privmsg_message = $db->sql_escape_string($privmsg_message);
/*****************************************************/
/* Convert HTML characters to special entities   END */
/*****************************************************/
	/* Start Admin PM Mod */
			$q = "SELECT *
				  FROM ". ADMIN_PM_TABLE ."
