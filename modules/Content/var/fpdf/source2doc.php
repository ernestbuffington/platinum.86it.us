...
////
  ...
  $html = '<strong>CLASSNAME:</strong> ' . $classname . '<br />' . endl;
  if ($extends != '') $html .= '<strong>EXTENDS:</strong> ' . $extends . '<br />' . endl;
...
////
  ...
  for($i=0; $i < count($vname) ; $i++)
  {
    ...
    $html .= '<td>' . endl;
    $html .= '<font size=2><strong>var</strong> ' . $vname[$i] . ';</font>' . endl;
    $html .= '</td>' . endl;
    $html .= '</tr>' . endl;
  }
...
/////
  ...
  for($i=0; $i < count($funcname) ; $i++)
  {
    ...
    $html .= '<font size=2><strong>function</strong> ' . $funcname[$i] . ')</font>' . endl;
    $html .= '</td>' . endl;
    $html .= '</tr>' . endl;
    ...
    if ($ret != '' or $desc != '')
    {
      ...
      if ($ret == '') $html .= '<font size=2><strong>Return:</strong> <i>?void?</i></font>' . endl;
      else $html .= '<font size=2><strong>Return:</strong> <i>' . trim($ret) . '</i></font>' . endl;
      $html .= '</td>' . endl;
      //@desc column
      $html .= '<td width="70%">' . endl;
      if ($desc == '') $html .= '<font size=2><strong>OBS:</strong> </font>' . endl;
      else $html .= '<font size=2><strong>OBS:</strong> ' . trim($desc) . '</font>' . endl;
      $html .= '</td>' . endl;
