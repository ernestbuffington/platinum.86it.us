...
switch($op) {
	...
	case 'rn_lgl_doc_add_apply': include $lgl_modPath . 'doc_add_apply.php'; break;
	case 'rn_lgl_doc_del': include $lgl_modPath . 'doc_delete.php'; break;
	case 'rn_lgl_doc_edit': include $lgl_modPath . 'doc_edit.php'; break;
	case 'rn_lgl_doc_edit_apply': include $lgl_modPath . 'doc_edit_apply.php'; break;
	case 'rn_lgl_doc_status': include $lgl_modPath . 'doc_status.php'; break;
	case 'rn_lgl_doc_view': include $lgl_modPath . 'doc_view.php'; break;
	case 'rn_lgl_cfg': include $lgl_modPath . 'cfg.php'; break;
	case 'rn_lgl_cfg_apply': include $lgl_modPath . 'cfg_apply.php'; break;
