...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
	...
	<tr> 
		<td class="row1" colspan="2" height="1"><img src="themes/AOG_Meteor/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END postrow -->
	<tr align="center"> 
