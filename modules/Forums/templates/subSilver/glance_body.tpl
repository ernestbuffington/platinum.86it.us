...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="2" cellspacing="1" border="0" class="forumline" height="100%">
	...
	<tr>
		...
		<td valign="middle" width="100%" class="row1"><span class="genmed"><a href="{recent.TOPIC_LINK}" class="genmed"> title="{topicrow.TOPIC_CONTENT}"{recent.TOPIC_TITLE}</a></span></td>
