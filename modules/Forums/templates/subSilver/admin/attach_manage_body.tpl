...
<div class="tabs_holder">
    <ul>
        <li class="tab_selected"><a href="#admin-tab-id-1">{L_ATTACHMENT_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-2">{L_ATTACHMENT_FILESIZE_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-3">{L_ATTACHMENT_NUMBER_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-4">{L_ATTACHMENT_OPTIONS_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-5">{L_ATTACHMENT_FTP_SETTINGS}</a></li>
