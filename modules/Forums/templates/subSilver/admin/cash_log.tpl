...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
		...
		<td class="{actionfilter.ROW_CLASS}">
			...
			<!-- END switch_linkpage_on -->
			<!-- BEGIN switch_linkpage_off -->
			<strong>{actionfilter.NAME}</strong>
			<!-- END switch_linkpage_off -->
		</td>
		<!-- END actionfilter -->
	</tr>
...
<table border="0">
	...
	<td>
		...
		<!-- END switch_linkpage_on -->
		<!-- BEGIN switch_linkpage_off -->
		<strong>{countfilter.NAME}</strong>
		<!-- END switch_linkpage_off -->
	</td>
	<!-- END countfilter -->
	<td>{L_PER_PAGE}</td>
...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	<tr>
		<!-- BEGIN actionfilter -->
		<td class="{actionfilter.ROW_CLASS}"><a href="{actionfilter.DELETECOMMAND}"><strong>{actionfilter.DELETE}</strong></a></td>
		<!-- END actionfilter -->
	</tr>
</table>
<br />
