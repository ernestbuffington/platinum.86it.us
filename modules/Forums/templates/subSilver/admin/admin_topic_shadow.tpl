...
<form method="post" action="{S_MODE_ACTION}" name="delete_ids">
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<!-- BEGIN topicrow -->
	<tr> 
	  <td class="{topicrow.ROW_CLASS}" align="center"><span class="gen">&nbsp;<input class="post" type="checkbox" name="delete_id_{topicrow.TOPIC_ID}">&nbsp;</span></td>
	  <td class="{topicrow.ROW_CLASS}" align="center"><span class="gen">{topicrow.TITLE}</span></td>
