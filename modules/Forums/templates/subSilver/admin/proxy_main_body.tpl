...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1">{L_PROXY_ENABLE}</td>
		<td class="row2"><input type="radio" name="proxy_enable" value="1" {ENABLE} />{L_ENABLED}&nbsp; &nbsp;<input type="radio" name="proxy_enable" value="0" {DISABLE} />{L_DISABLED}</td>
	</tr>
	<tr>
...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		...
		<td class="{proxyrow.ROW_CLASS}" align="center"><a href="http://network-tools.com/default.asp?host={proxyrow.IP_ADDRESS}" class="gen">{proxyrow.IP_ADDRESS}</a></td>
