<link type="text/css" rel="stylesheet" href="../../../includes/tab-assets/tabs.css">
...
<div class="tabs_holder">
    <ul>
        <li class="tab_selected"><a href="#admin-tab-id-1">{L_GENERAL_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-2">{L_MT_HEADER}</a></li>
        <li><a href="#admin-tab-id-3">{L_SIG_TITLE}</a></li>
        <li><a href="#admin-tab-id-4">{L_COOKIE_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-5">{L_PRIVATE_MESSAGING}</a></li>
        <li><a href="#admin-tab-id-6">{L_ANNOUNCEMENT_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-7">{L_ROPM_QUICK_REPLY}</a></li>
        <li><a href="#admin-tab-id-8">{L_ABILITIES_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-9">{L_AVATAR_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-10">{L_COPPA_SETTINGS}</a></li>
        <li><a href="#admin-tab-id-11">{L_EMAIL_SETTINGS}</a></li>
    </ul>

	<div class="content_holder">
        <form action="{S_CONFIG_ACTION}" method="post">
            <div id="admin-tab-id-1">
            ...
            <div id="admin-tab-id-7">
                <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
                    <tr>
                        <th class="thHead" colspan="2">{L_ROPM_QUICK_REPLY}</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="row2"><input class="post" type="text" name="ropm_quick_reply_smilies" size="4" maxlength="4" value="{ROPM_QUICK_REPLY_SMILIES}" /></td></tr>
                    <tr>
                        <td class="catBottom" colspan="2" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" class="liteoption" />
                        </td>
                    </tr>
            ...
            <div id="admin-tab-id-8">
                <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
                    ...
                    <tr>
                        <td class="row1">{L_SIG_PERPAGE}<br /><span class="gensmall">{L_SIG_PERPAGE_EXPLAIN}</span></td>
                        <td class="row2"><input type="radio" name="sig_perpage" value="1" {SIG_PERPAGE_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="sig_perpage" value="0" {SIG_PERPAGE_NO} /> {L_NO}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="row2"><input type="radio" name="guests_need_name" value="1" {GUESTS_NEED_NAME_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="guests_need_name" value="0" {GUESTS_NEED_NAME_NO} /> {L_NO}</td>
                    </tr>
                    <tr>
...
<script type="text/javascript" src="../../../includes/tab-assets/jquery-1.6.min.js"></script>
<script type="text/javascript" src="../../../includes/tab-assets/jquery-ui-1.8.10.min.js"></script>
<script type="text/javascript" src="../../../includes/tab-assets/tabs.js"></script>
