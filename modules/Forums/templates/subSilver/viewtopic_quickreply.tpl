...
<tr> 
  <td class="row1" colspan="2" align="center" height="28"> <form action="http://translate.google.com/translate_t" target="_blank" method=post>
      <br />
      &nbsp;&nbsp;<span class="genmed"><strong>Translate text:</strong></span><br />
      &nbsp;&nbsp; 
      ...
      <input type=submit value="Translate" class="mainoption">
    </form></td>
</tr></table>
