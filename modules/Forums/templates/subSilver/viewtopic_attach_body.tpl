...
AC_AX_RunContent( 'id','wmp','classid','CLSID:22d6f312-b0f6-11d0-94ab-0080c74c7e95','codebase','http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,0,0,0','standby','Loading Microsoft Windows Media Player components...','type','application/x-oleobject','pluginspage','http://www.microsoft.com/windows95/downloads/contents/wurecommended/s_wufeatured/mediaplayer/default.asp','src','{postrow.attach.cat_stream.U_DOWNLOAD_LINK}','name','MediaPlayer2','showcontrols','1','showdisplay','0','showstatusbar','1','autosize','1','autostart','0','visible','1','animationatstart','0','loop','0','filename','{postrow.attach.cat_stream.U_DOWNLOAD_LINK}','animationstart','0' ); //end AC code
</script><noscript><object id="wmp" classid="CLSID:22d6f312-b0f6-11d0-94ab-0080c74c7e95" codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,0,0,0" standby="Loading Microsoft Windows Media Player components..." type="application/x-oleobject"> 
	...
	<tr>
		<td colspan="2" align="center"><br />
		<script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0','width','{postrow.attach.cat_swf.WIDTH}','height','{postrow.attach.cat_swf.HEIGHT}','src','{postrow.attach.cat_swf.U_DOWNLOAD_LINK}','loop','1','allowscriptaccess','never','quality','high','scale','noborder','wmode','transparent','bgcolor','#000000','pluginspace','http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash','movie','{postrow.attach.cat_swf.U_DOWNLOAD_LINK}' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="{postrow.attach.cat_swf.WIDTH}" height="{postrow.attach.cat_swf.HEIGHT}"> 
...
<!--    
	...
	<tr>
		<!-- original: <td colspan="2" align="center"><br /><a href="{postrow.attach.cat_thumb_images.IMG_SRC}" target="_blank"><img src="{postrow.attach.cat_thumb_images.IMG_THUMB_SRC}" alt="{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}" border="0" /></a><br /><br /></td>-->
        <td colspan="2" align="center"><br /><a href="{postrow.attach.cat_thumb_images.IMG_SRC}" rel="lightbox"><img src="{postrow.attach.cat_thumb_images.IMG_THUMB_SRC}" alt="{postrow.attach.cat_thumb_images.DOWNLOAD_NAME}" border="0" /></a><br /><br /></td>
    </tr>
<!-- Lightbox MOD - END (sgtmudd) -->    
	</table>
	<div align="center"><hr width="95%" /></div>
