...
//  THANKS TO PALBIN FOR THE FIX FOR THE 404 ERROR

/***************************************************************************

*

*   Copyright:      PlatinumMyAdmin v0.3.4 © 2003, 2004 by Armin Altorffer
...

{
  ...
  $module['Platinum MODs']['PlatinumMyAdmin'] = $file;
...
include_once($phpbb_root_path . 'language/lang_' . $board_config['default_lang'] . '/lang_PlatinumMyAdmin.' . $phpEx);
...
$template->set_filenames(array(
  ...
  'body' => 'admin/PlatinumMyAdmin.tpl')
...

{
...

  {
    ...
    // Confirmation message require_onced?
...
include_once('./page_footer_admin.'.$phpEx);
    ...
    echo "Only the God Administrator can Access This Area!!";
