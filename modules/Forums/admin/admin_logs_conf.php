...
else
{
	...
	if( isset($_POST['submit']) )
	{
		$message = $lang['Log_Config_updated'] . "<br /><br />" . sprintf($lang['Click_return_admin_log_config'], "<a href=\"" . append_sid("admin_forums.$phpEx") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"" . append_sid("index.$phpEx?pane=right") . "\">", "</a>");
...
$choose_username_del = ( isset($_POST['delete_admin_select']) ) ? $_POST['delete_admin_select'] : array();
