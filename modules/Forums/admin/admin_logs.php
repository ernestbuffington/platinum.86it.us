	...
	for ($i = 0; $i < $numrows; $i++) 
	{
	    ...
	    $temp2_url = ('./../../../modules.php?name=Forums&file=viewtopic&t=' . $topic);
		 ...
		 $template->assign_block_vars('record_row', array( 
		    ...
		    'ACTION' => $action,
		    'TOPIC' => $topic,
		    'TOPIC_IMG' => '<a href="' . $temp2_url . '" target="_blank"><img src = "../../../' .$images['icon_latest_reply']. '" title="' . $lang['See_topic'] . '" alt="' . $lang['See_topic'] . '" border="0"></a>',
		    'USER_ID' => $user_id,
...
$log_list = ( isset($_POST['log_list']) ) ?  $_POST['log_list'] : array();
