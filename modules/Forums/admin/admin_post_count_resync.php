...
// Langauge File
//
include_once($phpbb_root_path.'language/lang_' . $board_config['default_lang'] . '/lang_pcount_resync.'.$phpEx);
...
else
{
	...
	if($mode == 'advanced')
	{
		...
		for( $i = 0; $i < $num_rows; $i++ )
		{
			// check to see which forums need to be include_onced in the resync
