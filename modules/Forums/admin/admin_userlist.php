	...
	default:
...

		{
...

			{
...

				{
...

					{
						...
						$rank_image = ( $ranksrow[$ji]['rank_image'] ) ? '<img src="/modules/Forums/' . $ranksrow[$ji]['rank_image'] . '" alt="' . $poster_rank . '" title="' . $poster_rank . '" border="0" /><br />' : '';
...

			{
				...
				$style_color = 'style="color:#' . $row['user_color_gc'] . '"';
