...
*/
$lang['Cash_clause'][CASH_LOG_DONATE] = '<a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a> donated <strong>%s</strong> to <a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a>';
...
Set 3 points
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_MODEDIT] = '<a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new">%s</a> edited <a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a>\'s Cash:<br />Added <strong>%s</strong><br />Removed <strong>%s</strong><br />Set to <strong>%s</strong>';
/* argument order: [admin/mod id][admin/mod name][currency name]
eg.
Joe created points 
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_CREATE_CURRENCY] = '<a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a> created <strong>%s</strong>';
/* argument order: [admin/mod id][admin/mod name][currency name]
eg.
Joe deleted $ 
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_DELETE_CURRENCY] = '<a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a> deleted <strong>%s</strong>';
/* argument order: [admin/mod id][admin/mod name][old currency name][new currency name]
eg.
Joe renamed silver to gold
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_RENAME_CURRENCY] = '<a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a> renamed <strong>%s</strong> to <strong>%s</strong>';
/* argument order: [admin/mod id][admin/mod name][copied currency name][copied over currency name]
eg.
Joe copied users' gold to points
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_COPY_CURRENCY] = '<a href="modules.php?name=Forums&file=profile&mode=viewprofile&u=%s" target="_new"><strong>%s</strong></a> copied users\' <strong>%s</strong> to <strong>%s</strong>';
$lang['Log'] = 'Log';
$lang['Action'] = 'Action';
$lang['Type'] = 'Type';
$lang['Cash_all'] = 'All';
