	...
	OpenTable();
		...
		echo "<table width='60%' border='1' cellpadding='4' cellspacing='4' align='center'>
		  <tr align='center'>
			...
			<td width='30%'><a href='".$admin_file.".php?op=linkus_block_config'><img src='modules/".$module_name."/images/block-config.png' border='0'><br />".$lang_new[$module_name]['BLOCK_CONFIG']."</a></td>
