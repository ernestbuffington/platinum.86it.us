...
echo "<center><img src='modules/". $module_name ."/images/linkus-logo.png'></center>";
echo "<br /><br />";
...
if ($config['button_standard'] == 1){
    ...
    if($numrows == 0){
        echo "<center><span color='red' size='3'>!".$lang_new[$module_name]['NO_ACTIVE_SITES']."!</span></center>";
    } else {
        if ($numrows > 0) {
