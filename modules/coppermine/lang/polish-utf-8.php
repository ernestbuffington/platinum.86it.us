...
if (defined('CONFIG_PHP')) $lang_config_data = array(
        ...
        array('Adresy docelowe dla linku \'Zobacz wiêcej zdjêæ\' w e-kartkach', 'ecards_more_pic_target', 0),
        array('Jêzyk', 'lang', 5),
        ...
        array('Maksymalna ilo¶æ pasków do wy¶wietlenia', 'max_tabs', 0),
        array('Wy¶wietl opis zdjêcia (oprócz tytu³u) poni¿ej miniatury', 'caption_in_thumbview', 1),
        array('Wy¶wietl ilo¶æ komentarzy poni¿ej miniatury', 'display_comment_count', 1),
        array('Domy¶lny porz±dek sortowania zdjêæ', 'default_sort_order', 3),
        array('Minimalna ilo¶æ g³osów niezbêdna do umieszczenia zdjêcia w kategorii \'Top Lista\'', 'min_votes_for_rating', 0),

        'Ustawienia wy¶wietlania zdjêæ &amp; komentarzy',
        array('Szeroko¶æ tabeli wy¶wietlaj±cej zdjêcia (piksele lub %)', 'picture_table_width', 0),
        array('Domy¶lne pokazywanie Informacji o zdjêciu', 'display_pic_info', 1),
        ...
        array('Maksymalna d³ugo¶æ opisu zdjêcia', 'max_img_desc_length', 0),
        ...
        array('Maksymalny rozmiar miniatury <strong>*</strong>', 'thumb_width', 0), 
        array('U¿yj wymiaru (szeroko¶æ, wysoko¶æ lub maksymalny widok dla miniatury)<strong>*</strong>', 'thumb_use', 7),    
        array('Twórz zdjêcia po¶rednie','make_intermediate',1),
        array('Maksymalna szeroko¶æ zdjêcia po¶redniego <strong>*</strong>', 'picture_width', 0),
        array('Maksymalny rozmiar uploadowanych zdjêæ (KB)', 'max_upl_size', 0),
        array('Maksymana wysoko¶æ lub szeroko¶æ uploadowanych zdjêæ (w pikselach)', 'max_upl_width_height', 0),
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('Pokazuj prywatn± ikonê albumu niezalogowanemu u¿ytkownikowi','show_private',1), 
        ...
        array('Metoda zmiany rozmiaru zdjêæ','thumb_method',2),
        array('¦cie¿ka dostêpu do narzêdzia konwertuj±cego ImageMagick / netpbm \'convert\' (na przyk³ad /usr/bin/X11/)', 'impath', 0),
        array('Dozwolone nazwy plików (w³a¶ciwe dla ImageMagick)', 'allowed_img_types',0),
        array('Komendy linii poleceñ dla ImageMagick', 'im_options', 0),
        array('Czytaj dane EXIF w plikach JPEG', 'read_exif_data', 1),
        array('¦cie¿ka katalogu z albumami<strong>*</strong>', 'fullpath', 0),
        array('Nazwa katalogu na zdjêcia u¿ytkowników<strong>*</strong>', 'userpics', 0),
        array('Prefix dla zdjêæ po¶rednich <strong>*</strong>', 'normal_pfx', 0),
        array('Prefix dla miniatur<strong>*</strong>', 'thumb_pfx', 0),
        array('Domy¶lne uprawnienia katalogów (LINUX i podobne systemy)', 'default_dir_mode', 0),
        array('Domy¶lne uprawnienia plików ze zdjêciami (LINUX i podobne systemy)', 'default_file_mode', 0),
        ...
        'Ró¿ne ustawienia',
        array('W³±cz tryb debugowania', 'debug_mode', 1),
