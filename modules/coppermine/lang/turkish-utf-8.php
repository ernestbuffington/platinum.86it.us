...
$lang_month = array(
    'Oca', 'Þub', 'Mar', 'Nis', 'May', 'Haz', 'Tem', 'Auð', 'Eyl', 'Eki', 'Kas', 'Ara');
...
$lang_bad_words = array(
    '*fuck*', 'asshole', 'assramer', 'bitch*', 'c0ck', 'clits', 'Cock', 'cum', 'cunt*', 'dago', 'daygo', 'dego', 'dick*', 'dildo', 'fanculo', 'feces', 'foreskin', 'Fu\(*', 'fuk*', 'honkey', 'hore', 'injun', 'kike', 'lesbo', 'masturbat*', 'motherfucker', 'nazis', 'nigger*', 'nutsack', 'penis', 'phuck', 'poop', 'pussy', 'scrotum', 'shit', 'slut', 'titties', 'titty', 'twaty', 'wank*', 'whore', 'wop*', '*sik*', 'am*', 'yarrak', 'yarak', 'orospu');
...
array(
'\'See more pictures\' hedef adres baðlantýsý e-Kartlar içinde', 'ecards_more_pic_target', 0),
array(
'Dil', 'lang', 5),
array(
'Aray&uuml;z', 'theme', 6),
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
    ...
    'notes' =>  '<ul>'.
			    '<li><strong>OK</strong> : Resminiz baþarý ile eklenmiþtir.'.
			    '<li><strong>DP</strong> : Resim bir kopya, baþka bir kopyasý veritabanýnda bulunmaktadýr'.
			    '<li><strong>PB</strong> : Resim y&uuml;klenemedi, resimlerin bulunduðu dizinlerin doðru ayarlanmýþ olduðundan emin olun'.
