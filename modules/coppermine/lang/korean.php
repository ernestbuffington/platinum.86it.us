...
$lang_translation_info =  array('lang_name_english' => 'Korean',  //the name of your language in English, e.g. 'Greek' or 'Spanish'
...
$lang_meta_album_names =  array('random' => '포토뉴스 갤러리',
    'lastup' => '최근 이미지',
...
$lang_errors =  array('access_denied' => '회원님의 권한으로 이페지를 보실 수 없습니다. 관리자에게 문의하세요.',
...
$lang_main_menu =  array('alb_list_title' => '앨범목록으로',
    'alb_list_lnk' => '앨범목록',
    'my_gal_title' => '개인갤러리로',
    'my_gal_lnk' => '개인갤러리',
    'my_prof_lnk' => '개인정보',
...
$lang_gallery_admin_menu =  array('upl_app_lnk' => '업로드승인',
    'config_lnk' => '환경설정',
    'albums_lnk' => '앨범관리',
...
$lang_user_admin_menu =  array('albmgr_lnk' => '개인앨범 생성 및 관리',
    'modifyalb_lnk' => '개인앨범 수정',
    'my_prof_lnk' => '개인정보',
);

$lang_cat_list =  array('category' => '카테고리',
    'albums' => '앨범',
    'pictures' => '이미지',
);

$lang_album_list =  array('album_on_page' => '앨범 %d  페이지 %d'
);

$lang_thumb_view =  array('date' => '일자',
    'name' => '파일이름', 
	'title' => '제목', 
	'sort_da' => '일자순 순차배열',
    'sort_dd' => '일자순 역차배열',
...
$lang_img_nav_bar =  array('thumb_title' => '목록으로 돌아가기',
...
$lang_rate_pic =  array('rate_this_pic' => '평가',
    'no_votes' => '(평가없음)',
...
$lang_display_thumbnails =  array('filename' => '파일이름 : ',
    'filesize' => '파일크기 : ',
    'dimensions' => '가로,세로 : ',
    'date_added' => '등록일 : ',
);

$lang_get_pic_data =  array('n_comments' => '%s 코멘트',
    'n_views' => '%s 조회',
    'n_votes' => '%s 평가',
);
...
$lang_smilies_inc_php =  array('Exclamation' => 'Exclamation',
    'Question' => 'Question',
...
$lang_albmgr_php =  array('alb_need_name' => '앨범이름이 필요합니다 !',
...
$lang_catmgr_php =  array('miss_param' => 'Parameters required for \'%s\'operation not supplied !',
...
$lang_config_php =  array('title' => '설정변경',
    'restore_cfg' => '기본설정으로',
    'save_cfg' => '변경사항저장',
    'notes' => '노트',
    'info' => '정보',
...
'이미지 및 썸네일 설정',
     ...
     array('썸네일 가로,세로 최대<strong>*</strong>', 'thumb_width', 0), 

 array('디멘죤사용 (가로 혹은 세로 혹은 썸네일의 최대모양)<strong>*</strong>', 'thumb_use', 7), 

 array('이미지 보기에 새로운 파일생성','make_intermediate',1),
     array('새로 생성될 파일의 최대크기(폭)<strong>*</strong>', 'picture_width', 0),
...
//'Custom fields for image description (leave blank if unused)',
 ...
 array('파일 이름에 사용금지할 문자', 'forbiden_fname_char',0),
     ...
     array('앨범 디렉토리 경로 <strong>*</strong>', 'fullpath', 0),
     array('사용자(회원) 업로드 이미지 경로 <strong>*</strong>', 'userpics', 0),
     array('새로 생성될 이미지의 접두어 <strong>*</strong>', 'normal_pfx', 0),
     array('썸네일의 접두어 <strong>*</strong>', 'thumb_pfx', 0),
...
$lang_db_input_php =  array('empty_name_or_com' => '이름을 입력하세요.',
...
$lang_delete_php =  array('caption' => '캡션',
    'fs_pic' => '원본 이미지',
    'del_success' => '삭제되었습니다!',
    'ns_pic' => '전시를 위한 새이미지',
    'err_del' => '삭제되지 않았습니다!!',
...
$lang_display_image_php =  array('confirm_del' => '이미지를 삭제하시겠습니까 ? \\n코멘트도 함께 삭제됩니다.',
    'del_pic' => '이미지삭제',
    'size' => '%s x %s pixels',
    'views' => '%s times',
    'slideshow' => '슬라이드쇼',
...
$lang_picinfo =  array('title' =>'사진 정보',
    'Filename' => '파일이름',
    'Album name' => '앨범이름',
    'Rating' => '평점 (%s 평가)',
    'Keywords' => '키워드',
...
$lang_display_comments =  array('OK' => '등록',
    'edit_title' => '코멘트 수정',
...
$lang_fullsize_popup =  array('click_to_close' => '화면닫기:이미지에 클릭', 
...
$lang_ecard_php = array('title' => 'e-card 보내기',
    'invalid_email' => '<strong>Warning</strong> : 유효하지 않은 이메일입니다 !',
...
$lang_editpics_php =  array('pic_info' => '이미지 상세정보',
    'album' => '앨범',
    'title' => '이미지 제목',
    'desc' => '이미지 설명',
    'keywords' => '검색 키워드',
...
$lang_groupmgr_php =  array('group_name' => '그룹이름',
    'disk_quota' => '디스크 할당',
    'can_rate' => '평가가능',
    ...
    'note1' => '<strong>(1)</strong> public album 에 업로드할 이미지는 관리자의 승인절차를 거쳐 게시됩니다.',
    'note2' => '<strong>(2)</strong> 사용자(회원)가 업로드한 이미지는 저작권법에 위배되지 않아야 게시됩니다. ',
    'notes' => 'Notes'
);
...
$lang_index_php =  array('welcome' => '환영합니다 !'
);

$lang_album_admin_menu =  array('confirm_delete' => '앨범을 삭제하시겠습니까 ? \\n모든 이미지와 코멘트도 함께 삭제됩니다.',
    'delete' => '삭제',
    'modify' => '앨범설정',
    'edit_pics' => '이미지별 정보수정 ',
);

$lang_list_categories =  array('home' => '갤러리 메인',
    'stat1' => '<strong>카테고리:[cat] 앨범:[albums] 이미지:[pictures] 코멘트:[comments] 조회:[views]</strong>',
    'stat2' => '<strong>앨범:[albums] 이미지:[pictures] 조회:[views]</strong>',
    'xx_s_gallery' => '%s\'갤러리',
    'stat3' => '<strong>카테고리:[cat] 앨범:[albums] 이미지:[pictures] 코멘트:[comments] 조회:[views]</strong>'
);

$lang_list_users =  array('user_list' => '사용자(회원)목록',
    'no_user_gal' => '사용자(회원) 갤러리가 없습니다.',
    'n_albums' => '%s 앨범',
    'n_pics' => '%s 이미지'
);

$lang_list_albums =  array('n_pictures' => '%s 이미지',
...
$lang_login_php =  array('login' => '로그인',
...
$lang_logout_php =  array('logout' => '로그아웃',
    'bye' => '%s님 로그아웃 되었습니다 !!',
...
$lang_modifyalb_php =  array('upd_alb_n' => '%s님 앨범 업데이트',
...
$lang_rate_pic_php =  array('already_rated' => '죄송합니다. 이미 평가하셨습니다.',
...
$lang_register_php =  array('page_title' => '회원등록',
...
$lang_reviewcom_php =  array('title' => '코멘트 다시보기',
    'no_comment' => '코멘트 없습니다.',
...
$lang_search_new_php =  array('page_title' => '새 이미지 검색',
    'select_dir' => '업로드 디렉토리',
    ...
    'target_album' => '<strong>&quot; %s &quot; 폴더의 이미지를 연결할 갤러리 선택 </strong>%s',
    'folder' => '업로드 폴더',
    'image' => '이미지',
    'album' => '갤러리',
    'result' => '결과',
    ...
    'notes' =>  '<ul>'.
                '<li><strong>OK</strong> : 연결성공'.
                '<li><strong>DP</strong> : 다른 갤러리에 이미 등록되어있음'.
                '<li><strong>PB</strong> : 실패, 업로드 디렉토리의 퍼미션등 추가작업 필요'.
...
$lang_banning_php =  array('title' => '사용금지자', 
...
$lang_upload_php =  array('title' => '이미지 업로드',
...
$lang_usermgr_php =  array('title' => '사용자(회원)관리',
    'name_a' => '이름 (a-z)',
    'name_d' => '이름 (z-a)',
    'group_a' => '그룹 (a-z)',
    'group_d' => '그룹 (z-a)',
