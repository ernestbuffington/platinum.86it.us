...
'äâãøåú ëììéåú',
array(
'ùí äâìøéä', 'gallery_name', 0),
array(
'úàåø äâìøéä', 'gallery_description', 0),
array(
'ëúåáú ãåà"ì ùì îðäì äâìøéä', 'gallery_admin_email', 0),
array(
'ëúåáú (URL) ùúåôéò áâìåéåú á÷éùåø "See more pictures" ', 'ecards_more_pic_target', 0),
array(
'ùôä', 'lang', 5),
array(
'ñâðåï òéöåá', 'theme', 6),
...
array(
'øåçá äèáìä äøàùéú (á-% àå áô÷éñìéí)', 'main_table_width', 0),
array(
'îñôø øîåú ÷èâåøéä ìäöéâ', 'subcat_level', 0),
array(
'îñôø àìáåîéí ìäöéâ', 'albums_per_page', 0),
array(
'îñôø òîåãåú ìøùéîú äàìáåîéí', 'album_list_cols', 0),
array(
'âåãì äãåâîéåú áôé÷ñìéí', 'alb_list_thumb_size', 0),
array(
'úåëï äãó äøàùé', 'main_page_layout', 0),
array(
'äöâ ãåâîéåú (îàìáåîéí áäéøøëéä äòìéåðä) áøùéîú ä÷èâåøéåú','first_level',1),
//'Thumbnail view',
'äâãøåú ìúöåâú ãåâîéåú',
array(
'îñôø òîåãåú áãó ãåâîéåú', 'thumbcols', 0),
array(
'îñôø ùåøåú áãó ãåâîéåú', 'thumbrows', 0),
array(
'îñôø ìùåðéåú î÷ñéîìé ìäöéâ', 'max_tabs', 0),
array(
'äöâú ëúåáéú (áðåñó ìëåúøú) îúçú ìãåâîéú', 'caption_in_thumbview', 1),
array(
'äöâú îñôø ääòøåú îúçú ìãåâîéú', 'display_comment_count', 1),
array(
'îéåï äúçìúé ùì äãåâîéåú', 'default_sort_order', 3),
array(
'îñôø ÷åìåú îéðéîìé äðãøù ìúîåðä ëãé ùúåôéò áøùéîú äãøåâéí äâáåäéí áéåúø ', 'min_votes_for_rating', 0),
array(
...
array(
'øåçá äèáìä (á-% àå áôé÷ñìéí)', 'picture_table_width', 0),
array(
'îéãò òì äúîåðä îåöâ ëáøéøú îçãì', 'display_pic_info', 1),
array(
'äàí ìñðï ðéáåìé ìùåï îääòøåú', 'filter_bad_words', 1),
array(
'äàí ìäøùåú ñîééìéí áäòøåú', 'enable_smilies', 1),
array(
...
array(
'àåøê î÷ñéîìé ùì úàåø úîåðä', 'max_img_desc_length', 0),
array(
'àåøê îéìä î÷ñéîìé (ìîðéòú "÷éù÷åùéí")', 'max_com_wlength', 0),
array(
'îñôø ùåøåú î÷ñéîìé áäòøä', 'max_com_lines', 0),
array(
'î÷ñéîåí àåøê ääòøä', 'max_com_size', 0),
array(
'äöâ øöåòú ñøè öéìåí', 'display_film_strip', 1),
array(
'îñôø äôøéèéí áøöåòú ñøè öéìåí', 'max_film_strip_items', 0),
array(
...
array(
'øîú àéëåú ì÷áöé JPEG', 'jpeg_qual', 0),
array(
'îîãéí î÷ñéîìééí ùì ãåâîéú <strong>*</strong>', 'thumb_width', 0),
array(
'ìäùúîù áîîãéí (øåçá àå âåáä àå î÷ñéîìé) ùì ãåâîéú <strong>*</strong>', 'thumb_use', 7),
array(
'î÷ñéîåí âåáä àå øåçá ùì ãåâîéú <strong>*</strong>', 'thumb_width', 0),
array(
'éöéøä/äöâä ùì úîåðåú áâåãì áéðééí','make_intermediate',1),
array(
'î÷ñéîåí âåáä àå øåçá ùì úîåðä áâåãì áéðééí <strong>*</strong>', 'picture_width', 0),
array(
'î÷ñéîåí âåãì ùì ÷åáõ úîåðä (KB)', 'max_upl_size', 0),
array(
'î÷ñéîåí âåáä àå øåçá ùì úîåðä', 'max_upl_width_height', 0),
//'User settings',
'äâãøåú îùúîùéí',
array(
'ìàôùø øéùåí ùì îùúîùéí çãùéí', 'allow_user_registration', 1),
array(
'ìáöò áãé÷ú ãåà"ì ùì îùúîù çãù', 'reg_requires_valid_email', 1),
array(
'ìäøùåú ëôéìåú ùì ëúåáåú ãåà"ì áéï îùúîùéí ùåðéí', 'allow_duplicate_emails_addr', 1),
array(
'ìàôùø ìîùúîùéí ìéöåø àìáåîéí ôøèééí', 'allow_private_albums', 1),
array('Show Users avatar instead of private album picture', 'avatar_private_album', 1),
//'Custom fields for image description (leave blank if unused)',

    'ùãåú ðåñôéí ìúàåø úîåðä (ìäùàéø øé÷ àí àéï öåøê)',
array(
'ùí ùãä 1', 'user_field1_name', 0),
array(
'ùí ùãä 2', 'user_field2_name', 0),
array(
'ùí ùãä 3', 'user_field3_name', 0),
array(
'ùí ùãä 4', 'user_field4_name', 0),
//'Pictures and thumbnails advanced settings',
'äâãøåú îú÷ãîåú ìúîåðåú åãåâîéåú',
array(
'ìäöéâ öìîéú àìáåí ôøèé ìîùúîù ùìà äúçáø','show_private',1),
array(
'úåéí àñåøéí áùí ÷åáõ úîåðä', 'forbiden_fname_char',0),
array(
'ñéåîåú îåúøåú ùì ÷áöé úîåðä', 'allowed_file_extensions',0),
array(
'ùéèú ùéðåé âåãì äúîåðä','thumb_method',2),
array(
'ðúéá ìúåëðéú Convert ùì çáéìú ImageMagick (ìîùì /usr/bin/X11/)', 'impath', 0),
array(
'ñåâé ÷áöé úîåðä îåúøéí (ø÷ òáåø ImageMagick)', 'allowed_img_types',0),
array(
'ôøîèøéí ìùåøú äô÷åãä ùì ImageMagick', 'im_options', 0),
array(
'÷øéàú îéãò îåøçá (EXIF) î÷áöé JPEG', 'read_exif_data', 1),
array(
'Read IPTC data in JPEG files', 'read_iptc_data', 1), // new in cpg1.2.0nuke
array(
'ðúéá ìîçéöú äàìáåîéí <strong>*</strong>', 'fullpath', 0),
array(
'îçéöä ìúîåðåú îùúîùéí <strong>*</strong>', 'userpics', 0),
array(
'÷éãåîú ìúîåðåú áâåãì áéðééí <strong>*</strong>', 'normal_pfx', 0),
array(
'÷éãåîú ìãåâîéåú <strong>*</strong>', 'thumb_pfx', 0),
array(
'áøéøú îçãì ìäøùàú îçéöåú', 'default_dir_mode', 0),
array(
'áøéøú îçãì ìäøùàú ÷áöé úîåðä', 'default_file_mode', 0),
array(
...
'äâãøåú Cookies åùôä',
array(
'ùí ä-Cookie ùì äâìøéä', 'cookie_name', 0),
array(
'ðúéá ä-Cookie ùì äâìøéä', 'cookie_path', 0),
array(
'÷éãåã úåéí (ùôä)', 'charset', 4),

    'äâãøåú ùåðåú',
array(
'äôòìú îöá Debug', 'debug_mode', 1),
array(
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
    ...
    'invalid_email' => '<strong>àæäøä</strong>: ëúåáú ãåà"ì ùâåéä!',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
    ...
    'note1' => '<strong>(1)</strong> äåñôú úîåðåú ìàìáåí öéáåøé ãåøùú àéùåø îðäì',
    'note2' => '<strong>(2)</strong> äåñôú úîåðåú ìàìáåí ôøèé ãåøùú àéùåø îðäì',
    'notes' => 'äòøåú'
);
...
$lang_list_categories = array(
    'home' => 'ãó øàùé',
    'stat1' => '<strong>[pictures]</strong> úîåðåú á- <strong>[albums]</strong> àìáåîéí å- <strong>[cat]</strong> ÷èâåøéåú òí <strong>[comments]</strong> äòøåú, ùðöôå <strong>[views]</strong> ôòîéí',
    'stat2' => '<strong>[pictures]</strong> úîåðåú á- <strong>[albums]</strong> àìáåîéí, ùðöôå <strong>[views]</strong> ôòîéí',
    'xx_s_gallery' => 'äâìøéä ùì %s',
    'stat3' => '<strong>[pictures]</strong> úîåðåú á- <strong>[albums]</strong> àìáåîéí òí <strong>[comments]</strong> äòøåú, ùðöôå <strong>[views]</strong> ôòîéí'
);
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
    ...
    'target_album' => '<strong>äåñôú úîåðåú ùì "</strong>%s<strong>" àì </strong>%s',
    'folder' => 'úé÷éä',
    'image' => 'úîåðä',
    'album' => 'àìáåí',
    'result' => 'úåöàä',
    ...
    'notes' =>  'î÷øà<ul>'.
			    '<li><strong>OK</strong> : äúîåðä ðåñôä áäöìçä'.
			    '<li><strong>DP</strong> : äúîåðä (àå úîåðä æää) ëáø ðîöàú áîàâø'.
			    '<li><strong>PB</strong> : äåñôú äúîåðä ðëùìä. éù ìáãå÷ àú äâãøåú äîòøëú åàú ääøùàåú ìîçéöåú'.
