...
'°¶·¯¸® ÀÌ¸§', 'gallery_name', 0),
array(
'°¶·¯¸® ¼³¸í', 'gallery_description', 0),
array(
'°ü¸®ÀÚ ÀÌ¸ÞÀÏ', 'gallery_admin_email', 0),
array(
'Address to nuke folder ie http://www.mysite.tld/html/ URL', 'ecards_more_pic_target', 0),
array(
'¾ð¾î¼±ÅÃ', 'lang', 5),
// for postnuke change
array(
...
//'Album list view','¾Ù¹ü¸ñ·Ï ¼³Á¤',
array(
'¸ÞÀÎÅ×ÀÌºíÀÇ Æø (pixels or %)', 'main_table_width', 0),
array(
'Ç¥½ÃÇÒ Ä«Å×°í¸® ·¹º§¼ö', 'subcat_level', 0),
array(
'Ç¥½ÃÇÒ ¾Ù¹ü ¼ö', 'albums_per_page', 0),
array(
'¾Ù¹üÀÇ ¼¼·Î ¿­', 'album_list_cols', 0),
array(
'½æ³×ÀÏ Å©±â(pixels)', 'alb_list_thumb_size', 0),
array(
'¸ÞÀÎÆäÀÌÁö¿¡ ºÒ·¯¿Ã ÄÁÅÙÆ®', 'main_page_layout', 0),
array(
'Ä«Å×°í¸®ÀÇ 1Â÷·¹º§ ¾Ù¹ü½æ³×ÀÏ º¸±â','first_level',1), 
//'Thumbnail view',

'½æ³×ÀÏ¸ñ·Ï ¼³Á¤',
array(
'½æ³×ÀÏ ÄÃ·³¼ö', 'thumbcols', 0),
array(
'½æ³×ÀÏ Çà¼ö', 'thumbrows', 0),
array(
'ºÒ·¯¿Ã ½æ³×ÀÏ ÃÑ¼ö', 'max_tabs', 0),
array(
'½æ³×ÀÏ°ú ÇÔ²² »ó¼¼Á¤º¸ Ãâ·Â', 'caption_in_thumbview', 1),
array(
'½æ³×ÀÏ°ú ÇÔ²² ÄÚ¸àÆ®¼ö¸¦ Ãâ·Â', 'display_comment_count', 1),
array(
'ÀÌ¹ÌÁö Á¤·Ä¹æ¹ý', 'default_sort_order', 3),
array(
'ÃÖ°íÆòÁ¡¿¡ ³ªÅ¸³¾ ÃÖ¼Ò Æò°¡È½¼ö', 'min_votes_for_rating', 0),
array(
...
array(
'ÀÌ¹ÌÁöº¸±â Å×ÀÌºíÀÇ Æø(pixels or %)', 'picture_table_width', 0),
array(
'ÀÌ¹ÌÁöÀÇ »ó¼¼Á¤º¸¸¦ ±âº»ÀûÀ¸·Î Ãâ·Â', 'display_pic_info', 1),
array(
'»ç¿ë±ÝÁö¾î ÇÊÅÍ¸µ »ç¿ë', 'filter_bad_words', 1),
array(
'ÄÚ¸àÆ®¿¡ ½º¸¶ÀÏ ¾ÆÀÌÄÜ »ç¿ë', 'enable_smilies', 1),
array(
...
array(
'ÀÌ¹ÌÁö ¼³¸í ÃÖ´ë ¹®ÀÚ¼ö', 'max_img_desc_length', 0),
array(
'´Ü¾î¹®ÀÚ ±æÀÌ(¶ç¿ö¾²±â¾øÀÌ)', 'max_com_wlength', 0),
array(
'ÄÚ¸àÆ® ¶óÀÎ Á¦ÇÑ', 'max_com_lines', 0),
array(
'ÄÚ¸àÆ® ÃÊ´ë ¹®ÀÚ¼ö', 'max_com_size', 0),
array(
'ÇÊ¸§½ºÆ®¸³ º¸±â', 'display_film_strip', 1), 
array(
'ÇÊ¸§½ºÆ®¸³ÀÇ Ç×¸ñ°¹¼ö', 'max_film_strip_items', 0), 
array(
...
'ÀÌ¹ÌÁö ¹× ½æ³×ÀÏ ¼³Á¤',
array(
'JPEG Ä÷¸®Æ¼', 'jpeg_qual', 0),
array(
'½æ³×ÀÏ °¡·Î,¼¼·Î ÃÖ´ë<strong>*</strong>', 'thumb_width', 0), 
array(
'µð¸àÁÔ»ç¿ë (°¡·Î È¤Àº ¼¼·Î È¤Àº ½æ³×ÀÏÀÇ ÃÖ´ë¸ð¾ç)<strong>*</strong>', 'thumb_use', 7), 
array(
'ÀÌ¹ÌÁö º¸±â¿¡ »õ·Î¿î ÆÄÀÏ»ý¼º','make_intermediate',1),
array(
'»õ·Î »ý¼ºµÉ ÆÄÀÏÀÇ ÃÖ´ëÅ©±â(Æø)<strong>*</strong>', 'picture_width', 0),
array(
'¾÷·Îµå ÀÌ¹ÌÁö ÃÖ´ë¿ë·® (KB)', 'max_upl_size', 0),
array(
'¾÷·Îµå ÀÌ¹ÌÁö °¡·Î,¼¼·Î ÃÖ´ëÅ©±â(pixels)', 'max_upl_width_height', 0),
//'User settings',
'»ç¿ë»ç(È¸¿ø)¼³Á¤',
array(
'È¸¿ø°¡ÀÔ Çã¿ë', 'allow_user_registration', 1),
array(
'È¸¿ø°¡ÀÔ½Ã ÀÌ¸ÞÀÏ À¯È¿¿©ºÎ °ËÁõ', 'reg_requires_valid_email', 1),
array(
'ÀÌ¸ÞÀÏ Áßº¹Çã¿ë ¿©ºÎ', 'allow_duplicate_emails_addr', 1),
array(
'»ç¿ëÀÚ °³ÀÎ¾Ù¹ü »ý¼º Çã¿ë', 'allow_private_albums', 1),
...
'ÀÌ¹ÌÁö¿Í ½æ³×ÀÏ °í±Þ¼³Á¤',
array(
'·Î±×ÀÎ µÇÁö ¾ÊÀº »ç¿ëÀÚ¿¡°Ô °³ÀÏ¾Ù¹ü ¾ÆÀÌÄÜ º¸¿©ÁÖ±â','show_private',1), 
array(
'ÆÄÀÏ ÀÌ¸§¿¡ »ç¿ë±ÝÁöÇÒ ¹®ÀÚ', 'forbiden_fname_char',0),
array(
'Çã¿ëÇÒ ÀÌ¹ÌÁöÆÄÀÏ È®ÀåÀÚ', 'allowed_file_extensions',0),
array(
'ÀÌ¹ÌÁö Å©±âÁ¶Àý ¹æ¹ý','thumb_method',2),
array(
...
array(
'¾Ù¹ü µð·ºÅä¸® °æ·Î <strong>*</strong>', 'fullpath', 0),
array(
'»ç¿ëÀÚ(È¸¿ø) ¾÷·Îµå ÀÌ¹ÌÁö °æ·Î <strong>*</strong>', 'userpics', 0),
array(
'»õ·Î »ý¼ºµÉ ÀÌ¹ÌÁöÀÇ Á¢µÎ¾î <strong>*</strong>', 'normal_pfx', 0),
array(
'½æ³×ÀÏÀÇ Á¢µÎ¾î <strong>*</strong>', 'thumb_pfx', 0),
array(
'µð·ºÅä¸® ±âº» ÆÛ¹Ì¼Ç', 'default_dir_mode', 0),
array(
'ÀÌ¹ÌÁö ±âº» ÆÛ¹Ì¼Ç', 'default_file_mode', 0),
array(
...
'ÄíÅ° ¹× ¹®¼­ ÀÎÄÚµù ¼³Á¤',
array(
'ÄíÅ°ÀÌ¸§', 'cookie_name', 0),
array(
'ÄíÅ°°æ·Î', 'cookie_path', 0),
array(
'ÀÎÄÚµù', 'charset', 4),
'±âÅ¸¼³Á¤',
array(
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
    'title' => 'e-card º¸³»±â',
    'invalid_email' => '<strong>Warning</strong> : À¯È¿ÇÏÁö ¾ÊÀº ÀÌ¸ÞÀÏÀÔ´Ï´Ù !',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
    ...
    'note1' => '<strong>(1)</strong> public album ¿¡ ¾÷·ÎµåÇÒ ÀÌ¹ÌÁö´Â °ü¸®ÀÚÀÇ ½ÂÀÎÀýÂ÷¸¦ °ÅÃÄ °Ô½ÃµË´Ï´Ù.',
    'note2' => '<strong>(2)</strong> »ç¿ëÀÚ(È¸¿ø)°¡ ¾÷·ÎµåÇÑ ÀÌ¹ÌÁö´Â ÀúÀÛ±Ç¹ý¿¡ À§¹èµÇÁö ¾Ê¾Æ¾ß °Ô½ÃµË´Ï´Ù. ',
    'notes' => 'Notes'
);
...
$lang_list_categories = array(
    'home' => '°¶·¯¸® ¸ÞÀÎ',
    'stat1' => '<strong>Ä«Å×°í¸®:[cat] ¾Ù¹ü:[albums] ÀÌ¹ÌÁö:[pictures] ÄÚ¸àÆ®:[comments] Á¶È¸:[views]</strong>',
    'stat2' => '<strong>¾Ù¹ü:[albums] ÀÌ¹ÌÁö:[pictures] Á¶È¸:[views]</strong>',
    'xx_s_gallery' => '%s\'°¶·¯¸®',
    'stat3' => '<strong>Ä«Å×°í¸®:[cat] ¾Ù¹ü:[albums] ÀÌ¹ÌÁö:[pictures] ÄÚ¸àÆ®:[comments] Á¶È¸:[views]</strong>'
);
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
    ...
    'target_album' => '<strong>&quot; %s &quot; Æú´õÀÇ ÀÌ¹ÌÁö¸¦ ¿¬°áÇÒ °¶·¯¸® ¼±ÅÃ </strong>%s',
    'folder' => '¾÷·Îµå Æú´õ',
    'image' => 'ÀÌ¹ÌÁö',
    'album' => '°¶·¯¸®',
    'result' => '°á°ú',
    ...
    'notes' =>  '<ul>'.
			    '<li><strong>OK</strong> : ¿¬°á¼º°ø'.
			    '<li><strong>DP</strong> : ´Ù¸¥ °¶·¯¸®¿¡ ÀÌ¹Ì µî·ÏµÇ¾îÀÖÀ½'.
			    '<li><strong>PB</strong> : ½ÇÆÐ, ¾÷·Îµå µð·ºÅä¸®ÀÇ ÆÛ¹Ì¼Çµî Ãß°¡ÀÛ¾÷ ÇÊ¿ä'.
...
// ------------------------------------------------------------------------- //
// File pagetitle.inc.php // new in cpg1.2.0nuke    
// ------------------------------------------------------------------------- //
