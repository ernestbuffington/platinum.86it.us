...
// ------------------------------------------------------------------------- //
define('PIC_VIEWS', 'Zobrazení');
define('PIC_VOTES', 'Hlas(ù))');
define('PIC_COMMENTS', 'Komentáø(ù)');
...
$lang_meta_album_names = array('random' => 'Náhodné obrázky',
    'lastup' => 'Nejnovìj¹í',
...
$lang_errors = array('access_denied' => 'Nemáte oprávnìní na tuto stránku',
...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Pøejít na seznam galerií',
...
$lang_gallery_admin_menu = array('upl_app_lnk' => 'Potvrzení uploadu',
...
$lang_user_admin_menu = array('albmgr_lnk' => 'Vytvoøit / organizovat moje galerie',
...
$lang_album_list = array('album_on_page' => '%d Galerií na %d stránkách'
    ); 
// ascending VZESTUPNE
...
$lang_img_nav_bar = array('thumb_title' => 'Zpìt na stránku s náhledy',
...
$lang_rate_pic = array('rate_this_pic' => 'Hodnotit tento obrázek ',
...
$lang_display_thumbnails = array('filename' => 'Jméno souboru : ',
    'filesize' => 'Velikost souboru : ',
    'dimensions' => 'Rozmìry : ',
    'date_added' => 'Datum pøidání : '
    );

$lang_get_pic_data = array('n_comments' => '%s Komentáø(ù)',
    'n_views' => '%s zobrazení',
    'n_votes' => '(%s hlas(ù))'
    );
// ------------------------------------------------------------------------- //
...
// File admin.php
// ------------------------------------------------------------------------- //
if (defined('ADMIN_PHP')) $lang_admin_php = array(0 => 'Opou¹tím Admin Mód....:-(',
        1 => 'Vstupuji do Admin Módu....:-)',
        );
// ------------------------------------------------------------------------- //
// File albmgr.php
// ------------------------------------------------------------------------- //
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array('alb_need_name' => 'Galerie musí mít jméno',
...
// File catmgr.php
// ------------------------------------------------------------------------- //
if (defined('CATMGR_PHP')) $lang_catmgr_php = array('miss_param' => 'Parametry potøebné pro \'%s\'operaci not supplied !',
...
// File config.php
// ------------------------------------------------------------------------- //
if (defined('CONFIG_PHP')) $lang_config_php = array('title' => 'Nastavení',
...
// for postnuke change
        ...
        'Nastavení zobrazení',
        array(
            '©íøka hlavní tabulky v (pixelech nebo %)', 'main_table_width', 0),
        array(
            'Poèet úrovní subkategorií', 'subcat_level', 0),
        array(
            'Poèet galerií na stránku', 'albums_per_page', 0),
        array(
            'Poèet sloupcù v pøehledu galerií', 'album_list_cols', 0),
        array(
            'Velikost náhledù v pixelech', 'alb_list_thumb_size', 0),
        array(
            'Obsah hlavní stránky', 'main_page_layout', 0),
        array(
            'Ukazovat v kategoriích náhledy galerií první úrovnì', 'first_level', 1), 
        // 'Thumbnail view',
        'Zobrazení náhledù',
        array(
            'Poèet sloupcù na stránku', 'thumbcols', 0),
        array(
            'Poèet øádkù na stránku', 'thumbrows', 0),
        array(
            'Maximální mno¾ství zálo¾ek', 'max_tabs', 0),
        array(
            'Zobrazit legendu obrázku pod náhledem', 'caption_in_thumbview', 1),
        array(
            'Zobrazit poèet komentáøù pod náhldem', 'display_comment_count', 1),
        array(
            'Základní øazení náhledù', 'default_sort_order', 3),
        array(
            'Min. poèet hlasù potøebný k zaøazení do seznamu \'Nejlépe hodnocené\'', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            '©íøka tabulky pro zobrazení obrázku (v pixelech nebo %)', 'picture_table_width', 0),
        array(
            'V¾dy zobrazit podrobné info', 'display_pic_info', 1),
        array(
            'CENZUROVAT slova v komentáøích', 'filter_bad_words', 1),
        array(
            'Povilit smajlíky v komentáøích', 'enable_smilies', 1),
        array(
        ...
        array(
            'Maximální dálka popisu obrázku', 'max_img_desc_length', 0),
        array(
            'Maximální délka slova v komentáøi', 'max_com_wlength', 0),
        array(
            'Maximální mno¾ství øádkù v komentáøi', 'max_com_lines', 0),
        array(
            'Maximální délka komentáøe', 'max_com_size', 0),
        array(
            'Ukázat filmový prou¾ek', 'display_film_strip', 1),
        array(
            'Poèet polo¾ek ve filmovém prou¾ku', 'max_film_strip_items', 0),
        array(
...
//'Pictures and thumbnails settings',
        ...
        array(
            'Kvalita souborù JPEG', 'jpeg_qual', 0),
        array(
            'Maximální rozmìry náhledu <strong>*</strong>', 'thumb_width', 0),
        array(
            'Pou¾ít rozmìr ( ¹íøka nebo vý¹ka nebo maximální rozmìr náhledu )<strong>*</strong>', 'thumb_use', 7),
        array(
            'Vytvoøit støední obrázek', 'make_intermediate', 1),
        array(
            'Maximální ¹íøka nebo vý¹ka støeního obrázku <strong>*</strong>', 'picture_width', 0),
        array(
            'Maximální velikost uploadovaných obrázkù (KB)', 'max_upl_size', 0),
        array(
            'Maximální rozmìry uploadovaných obrázkù (v pixelech)', 'max_upl_width_height', 0), 
        // 'User settings',
        'Nastavení u¾ivatelù',
        array(
            'Povolit registraci nových u¾ivatelù', 'allow_user_registration', 1),
        array(
            'Pro registraci vy¾adovat potvrzení admina', 'reg_requires_valid_email', 1),
        array(
            'Povolit pro dva u¾ivatele stejný email', 'allow_duplicate_emails_addr', 1),
        array(
            'Mají mít u¾ivatelé vlastní galerii?', 'allow_private_albums', 1),
array('Show Users avatar instead of private album picture', 'avatar_private_album', 1),
//'Custom fields for image description (leave blank if unused)',

        'Custom fields for image description (Nechte prázné a nezobrazí se)',
        array(
            'Jméno polo¾ky 1', 'user_field1_name', 0),
        array(
            'Jméno polo¾ky 2', 'user_field2_name', 0),
        array(
            'Jméno polo¾ky 3', 'user_field3_name', 0),
        array(
            'Jméno polo¾ky 4', 'user_field4_name', 0), 
        // 'Pictures and thumbnails advanced settings',
        'Obrázky a náhledy roz¹íøené nastavení',
        array(
            'Zobrazit ikonu zamknuté galerie nepøihlá¹enému u¾ivateli.', 'show_private', 1),
        array(
            'Znaky zakázané v názvech souborù', 'forbiden_fname_char', 0),
        array(
            'Povolené koncovky uploadovaných souborù', 'allowed_file_extensions', 0),
        array(
            'Metoda zmìny velikosti obrázkù', 'thumb_method', 2),
        array(
            'Cesta k ImageMagicu (pøíklad /usr/bin/X11/)', 'impath', 0),
        array(
            'Povolené typy obrázkù (pouze pro ImageMagic)', 'allowed_img_types', 0),
        array(
            'Parametry pro ImageMagic', 'im_options', 0),
        array(
            'Èíst EXIF data ze souborù JPEG', 'read_exif_data', 1),
        array(
            'Read IPTC data in JPEG files', 'read_iptc_data', 1), // new in cpg1.2.0nuke
        array(
            'Adresáø pro galerie <strong>*</strong>', 'fullpath', 0),
        array(
            'Adresáø pro galerie u¾ivatelù <strong>*</strong>', 'userpics', 0),
        array(
            'Prefix pro støednì velké obrázky <strong>*</strong>', 'normal_pfx', 0),
        array(
            'Prefix pro náhledy <strong>*</strong>', 'thumb_pfx', 0),
        array(
            'Základní mód pro adresáøe', 'default_dir_mode', 0),
        array(
            'Základní mód pro obrázky', 'default_file_mode', 0),
        array(
        ...
        array(
            'Jméno cookies u¾ívané programem (expertní volba)', 'cookie_name', 0),
        array(
            'Cesta pro cookies u¾ívaná programem (expertní volba)', 'cookie_path', 0),
        array(
            'Kódová stránka', 'charset', 4), 
        // 'Miscellaneous settings',
        'Dal¹í nastavení',
        array(
            'Zapnour debug mód (jen pro testování)', 'debug_mode', 1),
        array(
...
// File db_input.php
// ------------------------------------------------------------------------- //
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array('empty_name_or_com' => 'Vlo¾te jméno a Vá¹ komentáø',
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Jste si jist, ¾e chcete smazat tento obrázek ? \\nPøilo¾ené komentáøe budou straceny.',
    ...
    $lang_picinfo = array('title' => 'Informace o obrázku',
    ...
    $lang_fullsize_popup = array('click_to_close' => 'Kliknutím na obrázek zavøete okno',
        );
} 
// ------------------------------------------------------------------------- //
// File ecard.php
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Poslat pohlednici',
        'invalid_email' => '<strong>Varování</strong> : neplatná emailová adresa !',
...
// File editpics.php
// ------------------------------------------------------------------------- //
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'Info&nbsp;o obrázku',
        'album' => 'Galerie',
        'title' => 'Nadpis',
        'desc' => 'Popis',
        'keywords' => 'Klíèová slova',
...
// File groupmgr.php
// ------------------------------------------------------------------------- //
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Jméno skupiny',
        ...
        'note1' => '<strong>(1)</strong> Upload do veøejných galerií vy¾aduje potvrzení adminem',
        'note2' => '<strong>(2)</strong> Upload do galerie patøící u¾ivateli vy¾aduje potvrzení adminem',
        'notes' => 'Poznámky'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Domù',
        'stat1' => '<strong>[pictures]</strong> obrázky v <strong>[albums]</strong> glalerii <strong>[cat]</strong>v kategorii s <strong>[comments]</strong> komentáøi zobrazeno <strong>[views]</strong> krát',
        'stat2' => '<strong>[pictures]</strong> obrázky v <strong>[albums]</strong> galerii zobrazeno <strong>[views]</strong> krát',
        'xx_s_gallery' => '%s\' Galerie',
        'stat3' => '<strong>[pictures]</strong> obrázkù v <strong>[albums]</strong> galserii s <strong>[comments]</strong> komentáøi zobrazeno <strong>[views]</strong> krát'
        );

    $lang_list_users = array('user_list' => 'Seznam u¾ivatelù',
        'no_user_gal' => 'Nejsou ¾ádné u¾ivatelské alerie',
        'n_albums' => '%s galerií',
        'n_pics' => '%s obrázkù'
        );

    $lang_list_albums = array('n_pictures' => '%s obrázkù',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Tento obázek jste ji¾ hodnotil(a)',
...
EOT;
    ...
    $lang_register_php = array('page_title' => 'Registrace nového u¾ivatele',
...
// File reviewcom.php
// ------------------------------------------------------------------------- //
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array('title' => 'Kontrola komentáøù',
...
// if (defined('SEARCH_PHP'))
    $lang_search_php = array(0 => 'Prohledávat obrázky',
        );
// ------------------------------------------------------------------------- //
// File searchnew.php
// ------------------------------------------------------------------------- //
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Najít nové obrázky',
        ...
        'target_album' => '<strong>Vlo¾it obrázky z &quot;</strong>%s<strong>&quot; do </strong>%s',
        'folder' => 'Slo¾ka',
        'image' => 'Obrázek',
        'album' => 'Galerie',
        'result' => 'Výsledek',
        ...
        'notes' => '<ul>' . '<li><strong>OK</strong> : Tyto obrázky byly pøidány' . '<li><strong>DP</strong> : Zdvojení!, Tento obrázek ji existuje' . '<li><strong>PB</strong> : tento obrázek nelze pøidat, skontrolujte konfiguraci pøípadnì pøístupová práva' . '<li>Kdy¾ se neuká¾e \'oznaèení\' OK, DP, PB klepnìte na obrázek a uvidíte chybovou hlá¹ku generovanou PHP, která Vám pomù¾e zjistit pøíèinu problému' . '<li>Pokud dojde k timeoutu F5 nebo reload stránky by mìl pomoci' . '</ul>',
...
// File upload.php
// ------------------------------------------------------------------------- //
if (defined('UPLOAD_PHP')) $lang_upload_php = array('title' => 'Uploadnout obrázek',
...
// File util.php
// ------------------------------------------------------------------------- //
if (defined('UTIL_PHP')) $lang_util_php = array('title' => 'Zmìnit velikost obrázku',
