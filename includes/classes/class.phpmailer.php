...
class PHPMailer
{
    ...
    */
    ...
    function SmtpSend($header, $body) {
        include_once($this->PluginDir . "classes/class.smtp.php");
        $error = "";
        $bad_rcpt = array();
     ...
     * @return bool
     */
    function SetLanguage($lang_path = "") {
       global $currentlang,$language,$PHPMAILER_LANG;
	   /* lang added to main language files /language/lang-*.php*/
	    if(file_exists($lang_path."language/lang-$currentlang.php"))
            include_once($lang_path."language/lang-$currentlang.php");
        else if(file_exists($lang_path."language/lang-$language.php"))
            include_once($lang_path."language/lang-$language.php");
        else
        {
    ...
    */
        if(isset($this->language[$key]))
            ...
            return "function Lang:Language string failed to load: " . $key;
    }
