	...
	EditArea.prototype.open_file= function(settings){
		...
		if(settings['id']!="undefined")
		{
			...
			if(!_$(this.files[id]['html_id']) && id!="")
			{
				...
				elem.innerHTML= "<a onclick=\"javascript:editArea.execCommand('switch_to_file', editArea.filesIdAssoc['"+ html_id +"']);\" selec=\"none\"><strong><span><strong class=\"edited\">*</strong>"+ this.files[id]['title'] + close +"</span></strong></a>";
