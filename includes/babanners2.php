...
if ($numrows>0) {
  ...
  if ($bidinfo['flash']==1 AND $bidinfo['code']==0) {
    ...
    $babanners2  = "<a href='clicksba.php?bid=$bannum' target='_blank'><img src='".$bidinfo['imageurl']."' border='0' alt='".$bidinfo['alttext']."' title='".$bidinfo['alttext']."' height='".$bidinfo['height']."' width='".$bidinfo['width']."'></a>";
  }
} else {
  $babanners2  = "<a href='modules.php?name=$modname'><img src='modules/$modname/images/ban-banner-2.png' border='0' alt='$sitename' title='$sitename'></a>";
}
