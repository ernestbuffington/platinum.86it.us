...
$bresult4 = $db->sql_query("SELECT bid, datestr FROM ".$prefix."_nsnba_banners WHERE pid='4' AND active='-1'");
$numrows4 = $db->sql_numrows($bresult4);
if ($numrows4>0) {
  while (list ($id, $datestr) = $db->sql_fetchrow($bresult4)) {
