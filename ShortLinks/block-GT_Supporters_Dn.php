...
if (stristr($_SERVER['SCRIPT_NAME'], "block-GT_Supporters_Dn.php")) {
...
if ($supporterdn['require_user'] == 0 || is_user($user)) { $content .= "[ <a href='supporters-submit.html'>"._BESUPPORTER."</a> ]<br>\n"; }
